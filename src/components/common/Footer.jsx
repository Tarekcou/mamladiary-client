  ...
  return (
    <footer className="flex justify-around items-center place-items-center bg-gray-200 shadow-xl mx-auto p-4 w-full text-neutral-content">
      <div className="flex flex-col gap-1">
        ...
        >
          <img
            ...
            alt="govt logo"
          />
          <h1 className="text-blue-900 text-sm hover:underline transition cursor-pointer">
      ...
      <nav className="flex flex-col gap-1">
        <h1 className="font-bold font-bold text-blue-900 text-md">
          সামাজিক যোগাযোগ{" "}
        </h1>
      ...
      <aside className="flex items-center text-blue-900">
        <div className="flex flex-col justify-center items-center gap-3">
          <img
            className="rounded-full w-5 md:w-10 h-5 md:h-10"
            src={logo}
            alt="logo"
          />
          <div className="text-center">
            <h1 className="font-bold text-md">{t("planning")}</h1>
            <h1 className="text-sm">{t("post")}</h1>
            <h1 className="text-sm">{t("office")}</h1>
          </div>
        </div>
      </aside>
    </footer>
