...
const newSchema = {
  trackingNo: "26000",
  nagorikSubmission: {
    badi: [{ name: "Rahim", phone: "017...", address: "Cumilla" }],
    bibadi: [{ name: "Karim", phone: "018...", address: "Chattogram" }],
    aclandMamlaInfo: [
      {
  ...
  messagesToOffices: [
    {
      sentTo: {
        ...
        officeName: { bn: "AC Land Office", en: "AC Land Office" },
      },
      parties: {
...
const lastSchema = {
  _id: { $oid: "688910ac490044c39051dbad" },
  badi: [],
  bibadi: [],
  currentStage: {
    stage: "divCom",
    status: "বিভাগীয় কমিশনারের কার্যালয়, চট্টগ্রাম",
    officeName: { en: "divCom", bn: "বিভাগীয় কমিশনারের কার্যালয়, চট্টগ্রাম" },
    district: { bn: "চট্টগ্রাম", en: "Chattogram" },
  },
  caseInitiate: [
    {
  ...
  caseStages: [
    {
      acLand: {
        userId: "687f5fbaa061bbab51989a14",
        role: "acLand",
        mamlaName: "মিচ এল আপিল",
        mamlaNo: "46",
        year: "2010",
        ...
        caseHistory:
          "দেওয়ানী মামলা কোথায় ও কিভাবে দায়ের করা যায় ?\n\nদেওয়ানী মামলাগুলো ধরণ বুঝে বিভিন্ন আদালতে করতে হয়। যে মামলা যে আদালতে করার নিয়ম আছে, সেই আদালতের কর্মকর্তার কাছে আবেদন করে মামলাটি করা যায়। জমি-জমা সম্পর্কিত মামলাগুলো সাধারণত জেলা জজ আদালতের সহকারী জজ আদালত অথবা যুগ্ম জেলা জজ আদালতে দায়ের করতে হয়। পারিবারিক বিরোধের মামলা পারিবারিক আদালতে দায়ের করতে হয়। যিনি মামলা করার আবেদন করেন তিনি বাদী, আর যার বিপক্ষে মামলা করেন তিনি বিবাদী। বাদীর আবেদনের পর আদালত সমন দেন। সমনের পর বিবাদী লিখিত জবাব দেন। এরপর আদালত বাদী এবং বিবাদী দুই পক্ষকে আদালতে ডেকে তাদের অভিযোগ এবং জবাব শোনেন। সবশেষে আদালত তার রায় বা মামলার ফলাফল জানান।",
        documents: [
          { label: "Aut vel hic qui atqu", url: "Ad do corrupti ut q" },
        ],
        orderSheets: [],
        submittedAt: "2025-07-29T18:19:24.493Z",
        badi: [
          {
            badiName: "",
            badiPhone: "",
            badiAddress: "",
            name: "Aliquid voluptatem n",
            phone: "Blanditiis odit dolo",
            address: "Molestias veniam vo",
          },
        ],
        bibadi: [
          {
            ...
            bibadiPhone: "",
            bibadiAddress: "",
            name: "Soluta id incidunt ",
            phone: "Consectetur doloribu",
            address: "In lorem voluptate q",
          },
        ],
        initialOfficeName: { en: "Nangalkot", bn: "নাঙ্গলকোট" },
      },
      adc: {
        userId: "68812ed0329b1deed22623ff",
        role: "adc",
        mamlaName: "এল এ মিচ আপিল",
        mamlaNo: "94",
        year: "2010",
        district: { bn: "কুমিল্লা", en: "Cumilla" },
        officeName: { bn: "কুমিল্লা", en: "Cumilla" },
        orderSheets: [
          {
            date: "2020-01-01",
            formNo: "Enim sed ad consequa",
            orderNo: "17",
            order: "Sunt libero eaque vo",
            actionTaken: "Esse sed sunt amet ",
            remarks: "Eum occaecat aut exp",
          },
        ],
        badi: [
          {
            badiName: "Nesciunt omnis pers",
            badiPhone: "Rem aut delectus qu",
            badiAddress: "Iusto reprehenderit ",
          },
        ],
        bibadi: [
          {
            bibadiName: "Dolores temporibus n",
            bibadiPhone: "Tempore et sequi in",
            bibadiAddress: "Excepteur voluptate ",
          },
        ],
        remarks: "Nihil dolorum volupt",
        submittedAt: "2025-07-29T18:42:51.015Z",
      },
      divCom: {
        userId: "687f60dda061bbab51989a17",
        role: "divCom",
        badi: [
          {
            badiName: "Rerum accusantium la",
            badiAddress: "Vel hic et libero fa",
            phone: "018118",
          },
        ],
        bibadi: [
          {
            bibadiName: "Corrupti error fugi",
            bibadiAddress: "Amet esse nemo exer",
            phone: "01717",
          },
        ],
        mamlaName: "বাজার ফান্ড বন্দোবস্ত আপিল",
        mamlaNo: "92",
        year: "2034",
        district: { en: "Chattogram", bn: "চট্টগ্রাম" },
        officeName: { en: "divCom", bn: "বিভাগীয় কমিশনারের কার্যালয়" },
        orderSheets: [
          {
            date: "2002-02-10",
            formNo: "Quam explicabo In q",
            orderNo: "42",
            order:
              "দেওয়ানী মামলা কোথায় ও কিভাবে দায়ের করা যায় ?\n\nদেওয়ানী মামলাগুলো ধরণ বুঝে বিভিন্ন আদালতে করতে হয়। যে মামলা যে আদালতে করার নিয়ম আছে, সেই আদালতের কর্মকর্তার কাছে আবেদন করে মামলাটি করা যায়। জমি-জমা সম্পর্কিত মামলাগুলো সাধারণত জেলা জজ আদালতের সহকারী জজ আদালত অথবা যুগ্ম জেলা জজ আদালতে দায়ের করতে হয়। পারিবারিক বিরোধের মামলা পারিবারিক আদালতে দায়ের করতে হয়। যিনি মামলা করার আবেদন করেন তিনি বাদী, আর যার বিপক্ষে মামলা করেন তিনি বিবাদী। বাদীর আবেদনের পর আদালত সমন দেন। সমনের পর বিবাদী লিখিত জবাব দেন। এরপর আদালত বাদী এবং বিবাদী দুই পক্ষকে আদালতে ডেকে তাদের অভিযোগ এবং জবাব শোনেন। সবশেষে আদালত তার রায় বা মামলার ফলাফল জানান।\n\nদেওয়ানী মামলা কোথায় ও কিভাবে দায়ের করা যায় ?\n\nদেওয়ানী মামলাগুলো ধরণ বুঝে বিভিন্ন আদালতে করতে হয়। যে মামলা যে আদালতে করার নিয়ম আছে, সেই আদালতের কর্মকর্তার কাছে আবেদন করে মামলাটি করা যায়। জমি-জমা সম্পর্কিত মামলাগুলো সাধারণত জেলা জজ আদালতের সহকারী জজ আদালত অথবা যুগ্ম জেলা জজ আদালতে দায়ের করতে হয়। পারিবারিক বিরোধের মামলা পারিবারিক আদালতে দায়ের করতে হয়। যিনি মামলা করার আবেদন করেন তিনি বাদী, আর যার বিপক্ষে মামলা করেন তিনি বিবাদী। বাদীর আবেদনের পর আদালত সমন দেন। সমনের পর বিবাদী লিখিত জবাব দেন। এরপর আদালত বাদী এবং বিবাদী দুই পক্ষকে আদালতে ডেকে তাদের অভিযোগ এবং জবাব শোনেন। সবশেষে আদালত তার রায় বা মামলার ফলাফল জানান।\n",
            actionTaken: "Autem aut commodi mo",
            remarks: "Vitae quas nulla lor",
          },
        ],
        remarks: "Iure molestiae volup",
        submittedAt: "2025-07-29T19:01:20.785Z",
        nagorikData: {},
      },
    },
  ],
  stageHistory: [
    {
      ...
      sentTo: {
        role: "adc",
        officeName: { en: "Cumilla", bn: "জেলা প্রশাসকের কার্যালয়, কুমিল্লা" },
        district: { bn: "কুমিল্লা", en: "Cumilla" },
      },
      date: "2025-07-29T18:29:33.363Z",
    },
    {
      sentBy: {
        role: "adc",
